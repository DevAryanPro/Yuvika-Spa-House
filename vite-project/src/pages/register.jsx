...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Step 3: Insert into users table using service role if needed
      ...
      setError(
        err.message.includes('row-level security') 
          ? 'Registration failed due to security policy. Please try again later.'
          : err.message
      );
    } finally {
      setIsLoading(false);
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    minLength="8"
                    className={`block w-full pl-10 pr-3 py-3 border ${passwordError ? 'border-red-500' : 'border-gray-300'} rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="new-password"
                    required
                    className={`block w-full pl-10 pr-3 py-3 border ${error?.includes("Passwords don't match") ? 'border-red-500' : 'border-gray-300'} rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent`}
